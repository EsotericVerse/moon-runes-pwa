(()=>{
  ...
  function navItems(){
    ...
    if(current==='runes') return [
      ...
      {label:'管理者介紹',href:'https://whoami.lo3rwang.cc'},
    ...
    if(current==='author') return [
      {label:'簡介',href:'/'},{label:'脈絡',href:'/context'},{label:'統計',href:'/statics'},{label:'文化',href:'/evolution'},{label:'治理',href:'/governance'},
      {label:'管理者介紹',href:'https://manage.lo3rwang.cc'},
      {label:'回作者簡介',href:'/',home:true},{label:'回月典首頁',href:'https://loc.lo3rwang.cc',home:true}
    ];
    ...
    return [
      ...
      {label:'作者介紹',href:'https://whoami.lo3rwang.cc'},{label:'回月典首頁',href:'/',home:true}
    ];
  }
  function renderNav(){
