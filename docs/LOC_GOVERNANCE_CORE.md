...
- OW3gs：1–6 因的描述層 + 7–11 果的判定層 + 月相交互。
- OW3gs 1–6：背景、現在、資源、意向、外部擾動、尚未成形因素。
- OW3gs 7–11：成因、現在、未來、環境、心境。
- OW3gs 讀取順序：先讀 7–11 → 再掃描 1–6 → 最後套月相交互。
- OW3gs 治理解牌方式視為兩個模型，採「鑑古知今」為原則；重點是模型關聯，不是增加抽牌維度。
