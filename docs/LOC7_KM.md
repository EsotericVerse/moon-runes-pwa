...
- **Reverse：現況語意 → 符文映射**：把語句、事件、情緒或治理狀態映射回最接近的符文與方向，例如「這個狀況很像福半正」。這不是重新抽牌，而是把月之符文當共同語意座標。

### 7.10 Search / RAG 月之符文特化
...
- **符文脈絡**：符文彼此、符文與事件、符文與作品之間的關係、情境與 Graph；月之符文沙盒是最具代表性的互動實作。
...
**月之符文特化分類**
- **符文籤詩**：抽牌、籤詩、解牌。
- **符文脈絡**：關係、情境、Event、Scenario 與 Graph；月之符文沙盒是代表性實作。
