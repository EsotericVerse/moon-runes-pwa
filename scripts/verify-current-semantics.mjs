...
for(const token of ['selectNeonRows','silver.lrunes_runes','silver.lrunes_evolution_history'])if(!loader.includes(token))failures.push(`canonical Neon loader: missing ${token}`);
