...
if(map.scopes.loc.reserved.label!=='月之符文'||map.scopes.runes.reserved.label!=='語彙'||map.scopes.author.reserved.label!=='簡介'||map.scopes.governance.reserved.label!=='治理規則')throw new Error('Reserved NAV entry drifted');
