...
const required=[
  ...
  [sources.registry,"domain:'loc.lo3rwang.cc'"],[sources.registry,"domain:'lrunes.lo3rwang.cc'"],[sources.registry,"aliasName:'lrunes'"],[sources.registry,"mount:Object.freeze({host:'loc.lo3rwang.cc',path:'/runes'})"],[sources.registry,"domain:'dlwang.lo3rwang.cc'"],[sources.registry,"scopeType:'directory'"],[sources.registry,"aliasName:'dlwang'"],[sources.registry,"mount:Object.freeze({host:'loc.lo3rwang.cc',path:'/lo3rwang'})"],[sources.registry,"domain:'admin.lo3rwang.cc'"],
