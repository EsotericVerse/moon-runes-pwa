...
const required=[
  ...
  ...['月之符文','語彙','風格詞','治理規則','脈絡','統計','文化','治理','搜尋','作者頁面','管理者頁面','回月之符文首頁','回作者頁面','回治理頁面','回月典首頁','https://lo3rwang.lo3rwang.cc','https://manage.lo3rwang.cc','lrunes.lo3rwang.cc','context','statics','evolution','governance','search'].map(token=>[sources.nav,token]),
