...
const required=[
  ...
  [sources.registry,"scopeIdPattern:'^[A-Za-z]+,[sources.registry,"domain:'lrunes.lo3rwang.cc'"],[sources.registry,"mount:Object.freeze({host:'loc.lo3rwang.cc',path:'/lrunes'})"],[sources.registry,"domain:'dlwang.lo3rwang.cc'"],[sources.registry,"scopeType:'directory'"],[sources.registry,"aliasName:'dlwang'"],[sources.registry,"mount:Object.freeze({host:'loc.lo3rwang.cc',path:'/lo3rwang'})"],[sources.registry,"domain:'admin.lo3rwang.cc'"],
...
"],[sources.registry,"defaultScopeId:'loc'"],[sources.registry,"word:'loc'"],[sources.registry,"domain:'loc.lo3rwang.cc'"],[sources.registry,"domain:'lrunes.lo3rwang.cc'"],[sources.registry,"mount:Object.freeze({host:'loc.lo3rwang.cc',path:'/lrunes'})"],[sources.registry,"domain:'dlwang.lo3rwang.cc'"],[sources.registry,"scopeType:'directory'"],[sources.registry,"aliasName:'dlwang'"],[sources.registry,"mount:Object.freeze({host:'loc.lo3rwang.cc',path:'/lo3rwang'})"],[sources.registry,"domain:'admin.lo3rwang.cc'"],
  [sources.locApp,'ContextV2'],[sources.locApp,'StatisticsV2'],[sources.locApp,'CultureV2'],[sources.locApp,'GovernanceV2'],[sources.locApp,'SearchV2']
];
const forbiddenCurrent=['Language Model Framework','語言模型框架','Language Module Framework','語言系統模組框架','Symbolic Language Module','符號式語言模組','whoami.lo3rwang.cc','manage.lo3rwang.cc'];
const missing=required.filter(([source,token])=>!source.includes(token)).map(([,token])=>token);
