...
const requiredHome=['LOC月典','語言模型框架（Language Model Framework）','/pics/LunaRunes.jpg','LOC Model Architecture｜月典模型架構','ModelArchitectureExplorer',"name:'LunaRunes'","name:'Context'","name:'Music'","name:'Literary'","name:'MultiMedia'","name:'Algorithm'","name:'Module'","name:'Evolution'",'Governance｜治理架構層','Base66','卡片月相：無 / 真實月相：空亡'];
