...
const assertions=[
  ...
  ["reserved:['月之符文','/runes']","LOC reserved entry"],["reserved:['語彙'","LunaRunes reserved entry"],["reserved:['風格詞'","author reserved entry"],["reserved:['治理規則'","governance reserved entry"]
];
