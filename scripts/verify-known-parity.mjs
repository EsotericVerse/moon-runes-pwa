...
// GlobalFooter is temporarily unfrozen while its centered two-row layout and contact link are corrected.
...
console.log('[known-parity] Runes, Graph and frozen-source regressions are guarded; homepage blocks 1-2 and GlobalFooter remain temporarily unfrozen');
