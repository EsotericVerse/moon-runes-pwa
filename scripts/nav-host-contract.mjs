...
if(map.scopes.lo3rwang.host!=='lo3rwang.lo3rwang.cc')throw new Error('Author host drifted');
if(map.scopes.governance.host!=='admin.lo3rwang.cc')throw new Error('Management host drifted');
