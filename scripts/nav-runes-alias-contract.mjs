...
if(!runtime.includes("host==='lrunes.lo3rwang.cc'?'':'/runes'")||!runtime.includes("functionRoutes('https://lrunes.lo3rwang.cc')"))throw new Error('LunaRunes dual-entry route resolver drifted');
