...
export const SCOPE_REGISTRY=Object.freeze({
 loc:Object.freeze({id:'loc',zhName:'月典',enName:'Luna Codex',dataset:'loc',searchMode:'federated',host:'loc.lo3rwang.cc',canonicalOrigin:'https://loc.lo3rwang.cc',pathBase:'',reserved:['月之符文','https://lrunes.lo3rwang.cc/'],role:[['作者頁面','https://whoami.lo3rwang.cc/']],homes:[['回月典首頁','https://loc.lo3rwang.cc/']]}),
 runes:Object.freeze({id:'runes',zhName:'月之符文',enName:'LunaRunes',dataset:'runes',searchMode:'local',host:'lrunes.lo3rwang.cc',canonicalOrigin:'https://lrunes.lo3rwang.cc',pathBase:'/runes',reserved:['語彙','https://lrunes.lo3rwang.cc/'],role:[['管理者首頁','https://whoami.lo3rwang.cc/']],homes:[['回月之符文首頁','https://lrunes.lo3rwang.cc/'],['回月典首頁','https://loc.lo3rwang.cc/']],extensions:Object.freeze(['draw','list'])}),
 author:Object.freeze({id:'author',zhName:'作者',enName:'Author',dataset:'author',searchMode:'local',host:'whoami.lo3rwang.cc',canonicalOrigin:'https://whoami.lo3rwang.cc',pathBase:'',reserved:['風格詞','https://whoami.lo3rwang.cc/'],role:[['管理者頁面','https://manage.lo3rwang.cc/']],homes:[['回作者頁面','https://whoami.lo3rwang.cc/'],['回月典首頁','https://loc.lo3rwang.cc/']],extensions:Object.freeze(['style'])}),
 management:Object.freeze({id:'management',zhName:'管理',enName:'Management',dataset:'management',searchMode:'local',host:'manage.lo3rwang.cc',canonicalOrigin:'https://manage.lo3rwang.cc',pathBase:'',reserved:['治理規則','https://manage.lo3rwang.cc/'],role:[['管理者首頁','https://whoami.lo3rwang.cc/']],homes:[['回治理頁面','https://manage.lo3rwang.cc/'],['回月典首頁','https://loc.lo3rwang.cc/']],extensions:Object.freeze(['management'])})
});
...
export function scopeOwns(scope,dataset){if(scope==='author')return dataset==='author'||dataset==='loc'||dataset==='runes';return getScope(scope).dataset===dataset;}
