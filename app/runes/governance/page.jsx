...
export default function RunesGovernancePage(){
  return <main className="loc-next-main"><section className="loc-view">
    ...
    <div className="loc-grid two">
      ...
      <section className="loc-card"><h2>治理與歷史入口</h2><p>本頁只處理符文本體、66／67、Grammar、語意邊界與 LunaRunes 歷史。跨 Scope 的歷史查詢統一由 LOC Governance 提供，並保留來源 Scope。</p><p><a href="/governance">LOC 全域治理總覽</a>提供共同邊界，但不取代本 Scope 的 Master Data 與管理決定。</p><p><a href="/governance/history">歷史查詢／治理紀錄</a>集中查閱來源、版本與變更紀錄。</p></section>
    </div>
  </section></main>;
}
