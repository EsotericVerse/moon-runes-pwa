export const RUNES_HOME_CONTENT = {
  ...
  modes: {
    ...
    highlights: [
      { label: '單卡', text: '符文本義＋卡牌方向＋月相交互。', href: '/duel/one' },
      { label: '每日', text: '以今日為時間範圍的一張符文。', href: '/duel/daily' },
      { label: '雙卡', text: '因 → 果。', href: '/duel/two' },
      { label: '三卡', text: '源 → 轉 → 合。', href: '/duel/three' },
      { label: '五卡', text: '兩張過去成因＋一個意外變化＋兩張現在狀況。', href: '/duel/five' },
      { label: '11 卡 OW3gs', text: '1–6 因的描述層＋7–11 果的判定層。', href: '/duel/ow3gs' }
    ],
    paragraphs: [
