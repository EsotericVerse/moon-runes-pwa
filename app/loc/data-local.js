...
export async function getFreshLocalDataSegment(path,{hash='',version=''}={}){const value=await getLocalDataSegment(path);if(!value)return null;if(hash&&value.hash!==hash)return null;if(version&&value.source_version!==version)return null;return value;}
