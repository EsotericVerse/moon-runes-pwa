...
export default function Lo3rwangCultureView(){
  ...
  return <section className="loc-view">
    <header className="loc-hero">
      ...
      <div className="loc-actions"><a className="loc-button primary" href="https://lo3rwang.lo3rwang.cc/search?c=%E6%94%BF%E5%BE%B7%E6%96%87%E5%8C%96">搜尋政德文化</a><a className="loc-button" href="https://lo3rwang.lo3rwang.cc/context">脈絡分析</a></div>
    </header>
    ...
    <section className="loc-card" id="culture-history">
      <p className="loc-eyebrow">Culture · 文化變化</p>
      <h2>從微光到治理自己</h2>
    ...
    <section className="loc-card" id="culture-keywords">
      ...
      <div className="loc-list">
        {keywords.map(keyword=><article className="loc-subcard" key={keyword.id}>
          <h3><a href={`https://lo3rwang.lo3rwang.cc/search?c=${encodeURIComponent('政德文化')}&q=${encodeURIComponent(keyword.name)}`}>{keyword.name}</a></h3>
          <p>{keyword.summary}</p>
