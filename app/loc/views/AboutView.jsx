  ...
  return <section className="loc-view loc-home">
    ...
    <section className="loc-card home-author-words" id="author-words">
      <div className="home-section-heading">
        ...
        <h2>作者的話</h2>
        <p className="loc-subtitle">以古鑒今，是為了面對未來。整理過去，是為了把更多時間留給現在與未來。</p>
      </div>
      <div className="home-about-layout">
        <div className="home-author-copy">
          <p>月典從月之符文開始，把散落的語言、經驗與脈絡整理成可以重新取用的結構。對我來說，這不是要把人生固定成某種模式，而是把已知整理好，讓現在少一點反覆消耗。</p>
          <p>過去不能改寫，但可以被保存、回看與重新理解。莫忘初衷，也不要被過去困住；累了就休息，恢復之後再確認方向，繼續往前。</p>
          <p><strong>未來一定會有意外，但有準備就不必害怕。</strong> 整理過去，不是為了保存更多過去，而是為了有空間留下更多未來。</p>
        </div>
