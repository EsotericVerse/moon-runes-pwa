  ...
  return <section className="loc-view loc-home">
    <header className="loc-hero">
      ...
      <div className="loc-hero-copy">
        <p className="loc-core-line">月典（LOC，Luna Codex）是一套用來分析、拆解、組織、搜尋、治理並推演語言的語言系統模組框架（Language Module Framework）。
      ...
      <figure className="home-hero-visual">
        <img src="/pics/LOC-PicAll.png" alt="LOC 月典語言系統模組框架視覺理念圖" loading="eager" />
      </figure>
    </header>
    ...
    <section className="loc-card home-author-words" id="author-words">
      ...
      <div className="home-about-layout"><div className="home-author-copy"><p>月之符文本身是占卜指示籤詩的分析建議，重在符文本身的語彙交叉分析；巧妙的是，即使轉換語系也能通用，採取的是不帶神秘學預設的中立態度，重在文字本身而不論道德。</p><p>月典從月之符文開始，後來逐步演變成與月之符文相輔相成的語言系統模組框架；而月之符文，也在這個過程中演變成可被分析、治理與推演的符號式語言模組。</p><p>整合出月典，並不是為了把人生固定成某種發展模式，也不是為了賺錢，而是把散落、原本只能靠直覺掌握的語言與經驗，整理成可回看、可搜尋、可解析的結構，才能進一步面對未來的各種可能。</p></div><figure className="home-about-figure"><img src="/pics/aboutme.png?v=20260914" alt="作者 Lucas Oscar Wang 政德" loading="eager" decoding="async" /></figure></div>
    </section>
  </section>;
}
