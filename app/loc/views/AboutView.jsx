...
人總會因為各種狀況導致風格突變，例如當兵，例如車禍意外等等。但每個人總是世界上獨一無二的人，這些風格都應該被紀錄。而也都是很正常的變化，並非空穴來風或是天外飛來一筆的改變。</p><p>
改變總是循序漸進，從文字可見一斑。</p><p>
LOC為4D語言解析框架，將文字語言除了以語彙、關鍵詞、時間進行解析統合風格，並納入沒有文字紀錄的多媒體延伸。</p><p>
語言本質是用於紀錄時間跟傳達文字所不能表述的各項訊息，例如情緒，例如讚嘆。就算文字紀錄再多，也不能忘記人類本質。除了舊有的文化，更應該將新興的多媒體納入紀錄的範圍。</p><p>
