...
function ProgressGrid({items,label}){
  return <div className="home-progress-grid" aria-label={label}>
    {items.map(([category,title,copy],index)=><article className="home-progress-item" key={`${category}-${index}`}>
  ...
  return <section className="loc-view loc-home">
    ...
    <section className="loc-card home-copy-block home-context" id="context">
      ...
      <div className="home-progress" id="current-progress">
        <p className="loc-eyebrow">Current Progress · 目前進度</p>
    ...
    <section className="loc-card home-copy-block home-culture" id="culture">
      ...
      <div className="home-progress">
        <p className="loc-eyebrow">Current Progress · 目前進度</p>
        <ProgressGrid items={cultureProgressItems} label="文化目前進度" />
      </div>
    </section>
