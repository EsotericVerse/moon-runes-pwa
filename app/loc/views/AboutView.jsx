  ...
  return <section className="loc-view loc-home">
    ...
    <section className="loc-card home-author-words" id="author-words">
      <div className="home-section-heading">
        ...
        <h2>作者的話</h2>
        <p className="loc-subtitle">以古鑒今，是為了面對未來。治理過去的已知，是為了把時間還給現在的未知。</p>
      </div>
      <div className="home-about-layout">
        <div className="home-author-copy">
          ...
          <p>整合出月典，並不是為了把人生固定成某種發展模式，也不是為了賺錢，而是把散落、原本只能靠直覺掌握的語言與經驗，整理成可回看、可搜尋、可解析的結構。過去不能改寫，但可以從現在重新理解；從留下的脈絡看見軌跡與擺盪，才能為尚未發生的未來做更充分的準備。</p>
        </div>
