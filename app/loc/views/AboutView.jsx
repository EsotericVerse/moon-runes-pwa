  ...
  return <section className="loc-view loc-home">
    ...
    <section className="loc-card home-author-words" id="author-words">
      <div className="home-section-heading">
        ...
        <h2>作者的話</h2>
        <p className="loc-subtitle">以古鑒今，是為了面對未來。治理過去的已知，是為了讓現在有更充分的準備。</p>
      </div>
      <div className="home-about-layout">
        <div className="home-author-copy">
          ...
          <p>整合出月典，並不是為了把人生固定成某種發展模式，也不是為了賺錢，而是把散落、原本只能靠直覺掌握的語言與經驗，整理成可以重新取用的結構。這延續的是我早期「時空定錨論」的人生演算法：過去不能改寫，但可以被保存、回看與重新理解；以古鑒今的目的，是校準現在的判斷、避免重複已知錯誤，讓自己在未知真正到來以前，為未來做好更充分的準備。文字與文化的變化，是其中可以觀察的脈絡，不是終點。</p>
        </div>
