...
const AUTHOR_LINES = [
  ...
  ['以古鑒今，是為了面對未來。','保存過去不是為了停留在過去，而是讓現在有足夠脈絡重新理解已知，從歷史軌跡與擺盪中準備下一步。'],
...
export default function MyStyleView(){
  ...
  return <section className="loc-view">
    ...
    <section className="loc-card" id="time-anchor">
      ...
      <h2>時空定錨與面向未來</h2>
      <p><strong>時間長河向前，過去本身不回頭。</strong> 早期小說創作中的「時空定錨」概念，是在過去留下可以重新回訪的座標；回到定錨點，不是改寫已發生的事情，而是重新取得當時的脈絡。</p>
      <p><strong>現在可以重新理解過去。</strong> 保存原始資料、當時狀態與規則版本，再以現在的觀察位置重新解析同一份紀錄，就能比較「當時怎麼理解」與「現在怎麼理解」，看見軌跡與 Oscillation。</p>
      <p><strong>以古鑒今，是為了面對未來。</strong> 過去提供經驗，現在負責校準與治理；整理已知的目的不是沉溺於歷史，而是讓尚未發生的未來有更充分的準備。</p>
      <p className="loc-core-line">定錨保存過去 → 現在重新解析 → 比較軌跡與擺盪 → 準備未來</p>
    </section>
