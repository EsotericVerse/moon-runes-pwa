...
export default function MyStyleView(){
  ...
  return <section className="loc-view">
    ...
    <section className="loc-card" id="time-anchor">
      ...
      <p><strong>時空定錨論首先是一套人生演算法。</strong> 它不是以文字演化為主體；文字、文化與分類的變化只是後來可以套用同一方法觀察的資料。真正的核心，是人如何利用已知的過去，讓現在有能力對尚未發生的未來做好準備。</p>
      <p><strong>時間長河單向前進，過去不能被改寫。</strong> 定錨是在已經發生的時間中留下可以重新回訪的座標。回到定錨點的意義，不是重新開始那段歷史，而是重新取得當時的經驗、條件與脈絡。</p>
      <p><strong>以古鑒今是主體。</strong> 從現在的立足點重新檢視過去，辨認哪些經驗仍然有效、哪些判斷需要校準、哪些錯誤不必再重複；觀察文字演化、文化軌跡或 Oscillation，都只是幫助理解脈絡的方法。</p>
      <p><strong>面對未來的準備才是目的。</strong> 回看與分析如果不能改善現在的判斷，就失去定錨的實際價值。整理過去的已知，是為了增加現在可以使用的資訊、時間與選擇，使自己在未知真正到來以前準備得更充分。</p>
      <p className="loc-core-line">定錨過去 → 以古鑒今 → 校準現在 → 準備未來</p>
    </section>
