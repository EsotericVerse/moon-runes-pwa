...
const AUTHOR_LINES = [
  ...
  ['以古鑒今，是為了面對未來。','保存與回看過去的核心目的，是讓現在能從已知經驗中校準判斷、補足準備，再走向尚未發生的未來。'],
  ['整理過去，不是為了保存更多過去，而是為了有空間留下更多未來。','經歷越多，需要整理與承載的記憶也越多；把已知重新整理，才能把有限的時間、注意力與心力留給現在與新的美好時刻。'],
...
export default function MyStyleView(){
  ...
  return <section className="loc-view">
    ...
    <section className="loc-card" id="time-anchor">
      <p className="loc-eyebrow">Time Anchor · 以古鑒今</p>
      <h2>時空定錨論：以古鑒今，準備未來</h2>
      <p><strong>時空定錨論首先是一套人生演算法。</strong> 它最後還是要回到人生本身：人活得越久，留下的經驗、記憶與牽掛越多，但一天仍然只有二十四小時，能隨時拿來思考與處理事情的注意力與心力也有限。</p>
      <p><strong>整理過去，是為了把資源還給現在。</strong> 過去不能改寫，但可以被保存、回看與重新理解。把已經發生的事情重新整理，留下值得留下的，理解已經發生的，也放下不必反覆消耗自己的部分，才能釋放更多時間去記錄新的、更好的時刻。</p>
      <p><strong>莫忘初衷，但也不要被過去困住。</strong> 不要因為經歷太多事情，就忘記過去那個自己；也不要因為放不下過去的自己，而讓現在無法前進。隨著年歲與經歷增加，人會變得更社會化、更懂得調整自己，但核心仍然可以被保存。</p>
      <p><strong>我相信未來仍然大致掌握在自己的選擇裡。</strong> 意外一定會有，但只要方向、原則與準備還在，就不至於因一次意外偏離得太遠。以古鑒今的目的，不是活在過去，而是讓自己在未知真正到來以前準備得更充分。</p>
      <p><strong>累了就充分休息，休息不是偏離航線。</strong> 等恢復之後，再確認自己的位置，繼續啟程。未來即使有意外，只要曾經整理、思考並準備過，就不必因未知而害怕。</p>
      <p className="loc-core-line">整理過去 → 釋放現在 → 保留初衷 → 充分休息 → 準備未來</p>
    </section>
