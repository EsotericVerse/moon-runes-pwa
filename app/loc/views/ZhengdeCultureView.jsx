...
export default function ZhengdeCultureView(){
  ...
  return <section className="loc-view">
    ...
    <section className="loc-card">
      ...
      <p><strong>政德風</strong>保留為文字與歌曲的表達風格；<strong>政德文化</strong>則是更大的時間性集合，包含風格、作品、價值觀、治理方法、意象與時期變化。</p>
    </section>
    ...
    <section className="loc-card" id="culture-layers">
      ...
      <p><strong>Search／搜尋</strong>負責把兩者接起來：搜尋政德關鍵字時，直接列出命中的歌曲、文字、治理資料與其他作品，並由既有 Graph 關係提供定位。</p>
    </section>
