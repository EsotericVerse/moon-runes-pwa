...
import { getSearchCollection } from '../search-collections';
...
export default function SearchView(){
  ...
  const {scope,current,host,pathname}=useCurrentScope();
  ...
  async function executeSearch(rawQuery){
    ...
    if(!q)return;
    const collection=getSearchCollection(current.searchCollection);
