...
const TABLES=Object.freeze({
  all:Object.freeze([
    ...
    ['silver.lo3rwang_galaxy_media','音樂與多媒體',['media_id','scope_id','galaxy_id','parent_media_id','source_platform','source_native_id','media_type','title','url','description','created_at','created_date','playlist','style_prompt','publication_status','play_count','like_count','view_count','is_representative']]
  ]),
  '月之符文':Object.freeze([
