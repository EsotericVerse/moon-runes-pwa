export const LOC_DATA = Object.freeze({
  ...
  LO3RWANG_GOVERNANCE_REGISTRY: '/data/json/registries/LO3RWANG_GOVERNANCE_REGISTRY.json',
  LO3RWANG_PERIOD_KEYWORD_ANALYSIS: '/data/json/registries/LO3RWANG_PERIOD_KEYWORD_ANALYSIS.json',
  LUNARUNES_DAILY_RUNE_REPO_HISTORY: '/data/json/registries/LUNARUNES_DAILY_RUNE_REPO_HISTORY.json',
  CONTEXT_EVENT_SNAPSHOT: '/data/json/registries/CONTEXT_EVENT_SNAPSHOT.json',
