export const LOC_DATA = Object.freeze({
  ...
  MUSIC_PERIOD_KEYWORD_ANALYSIS: '/data/json/registries/MUSIC_PERIOD_KEYWORD_ANALYSIS.json',
  WRITING_REGISTRY: '/data/json/registries/WRITING_REGISTRY.json',
  GOVERNANCE_REGISTRY: '/data/json/registries/GOVERNANCE_REGISTRY.json',
  PERIOD_KEYWORD_ANALYSIS: '/data/json/registries/GOVERNANCE_PERIOD_KEYWORD_ANALYSIS.json',
  GOVERNANCE_PERIOD_KEYWORD_ANALYSIS: '/data/json/registries/GOVERNANCE_PERIOD_KEYWORD_ANALYSIS.json',
  DAILY_RUNE_REPO_HISTORY: '/data/json/registries/DAILY_RUNE_REPO_HISTORY.json',
  DAILY_RUNE_REPO_HISTORY: '/data/json/registries/DAILY_RUNE_REPO_HISTORY.json',
  EVENT_SNAPSHOT: '/data/json/registries/EVENT_SNAPSHOT.json',
