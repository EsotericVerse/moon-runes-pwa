...
export default function Lo3rwangGovernancePage(){
  return <main className="loc-next-main"><section className="loc-view">
    <header className="loc-hero"><p className="loc-eyebrow">lo3rwang Governance</p><h1>作者治理</h1><p className="loc-subtitle">管理作者身份、政德風、作品脈絡、個人時期與歷史；共用 LOC 原則，但保有自己的資料與權威。</p></header>
    ...
    <div className="loc-grid two">
      <section className="loc-card"><p className="loc-eyebrow">Scope</p><h2>治理範圍</h2><p className="loc-core-line">Author Identity → 政德風 → Works／Keywords → ERA／History</p><p>作者治理管理作者身份、保留名稱、政德風、作品索引、關鍵字、作者 ERA、公開自我描述與相關歷史。這些內容屬於 lo3rwang 個人 Scope，不因被 LOC 搜尋或分析而改變所有權。</p></section>
      ...
      <section className="loc-card"><p className="loc-eyebrow">Links</p><h2>治理與歷史入口</h2><p>本頁管理 lo3rwang 個人 Scope；跨 Scope 的歷史查詢由 LOC Governance 統合，並保留原始來源。</p><p><a href="https://lo3rwang.lo3rwang.cc/">作者首頁</a></p><p><a href="/governance">LOC 全域治理總覽</a></p><p><a href="/governance/history">歷史查詢／治理紀錄</a></p><p><a href="/runes/governance">LunaRunes 符文治理</a></p></section>
    </div>
  </section></main>;
}
