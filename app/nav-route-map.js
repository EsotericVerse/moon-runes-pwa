...
export function getNavScopeConfig(scope,host=''){
  if(scope==='runes'){
    ...
    return {scope:'runes',base,reserved:['語彙','https://lrunes.lo3rwang.cc/list'],role:[['管理者首頁','https://lo3rwang.lo3rwang.cc']],homes:[['回月之符文首頁',base||'/'],['回月典首頁','https://loc.lo3rwang.cc']]};
  }
  ...
  return {scope:'loc',base:'',reserved:['月之符文','https://lrunes.lo3rwang.cc'],role:[['管理者首頁','https://lo3rwang.lo3rwang.cc']],homes:[['回月典首頁','/']]};
}
