...
export function getNavScopeConfig(scope,host=''){
  if(scope==='runes'){
    ...
    return {base,functions:functionRoutes('https://lrunes.lo3rwang.cc'),reserved:['語彙',base||'/'],role:[['管理者介紹','https://whoami.lo3rwang.cc']],homes:[['回月之符文首頁',base||'/'],['回月典首頁','https://loc.lo3rwang.cc']]};
  }
  if(scope==='author')return {base:'',functions:functionRoutes('https://whoami.lo3rwang.cc'),reserved:['簡介','/'],role:[['管理者介紹','https://manage.lo3rwang.cc']],homes:[['回作者簡介','/'],['回月典首頁','https://loc.lo3rwang.cc']]};
  if(scope==='governance')return {base:'',functions:functionRoutes('https://manage.lo3rwang.cc'),reserved:['治理規則','/'],role:[['管理者介紹','https://manage.lo3rwang.cc']],homes:[['回治理頁面','/'],['回月典首頁','https://loc.lo3rwang.cc']]};
  return {base:'',functions:functionRoutes('https://loc.lo3rwang.cc'),reserved:['月之符文','/runes'],role:[['作者介紹','https://whoami.lo3rwang.cc']],homes:[['回月典首頁','/']]};
}
