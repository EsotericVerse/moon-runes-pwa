  ...
  return <div className="scope-overview-graph-wrap">
    <svg viewBox="0 0 1200 720" className="scope-overview-graph" role="img" aria-label="首頁 Graph 總覽">
      ...
      <g role="button" tabIndex="0" onClick={()=>setExpanded(value=>!value)}
        ...
        <text x="600" y="405" textAnchor="middle" fill="currentColor" fontSize="12" opacity=".72">{expanded?'收合':'點一下展開'}</text>
      </g>
