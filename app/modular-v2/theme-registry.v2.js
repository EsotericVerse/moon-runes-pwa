...
const slots=[
  ...
  {id:'theme-4',styleKey:'nature',group:'自然',label:'自然',scheme:'light',tokens:{'--loc-bg':'#b8f28b','--loc-panel':'#efffe8','--loc-panel-2':'#8ee66b','--loc-text':'#12351f','--loc-accent':'#28a745','--loc-gold':'#16823a','--loc-heading':'#0b2b17','--loc-muted':'#34733f','--loc-body-glow':'#c6e8cb','--loc-body-mid':'#eaf6ec','--loc-hero-start':'rgba(201,235,207,.97)','--loc-hero-end':'rgba(249,253,250,.98)'}},
