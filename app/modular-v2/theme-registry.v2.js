...
const slots=[
  {id:'theme-1',styleKey:'soul',group:'靈魂',label:'靈魂',scheme:'dark',tokens:{'--loc-bg':'#1d2f8f','--loc-panel':'#0d1a4a','--loc-panel-2':'#162765','--loc-text':'#eef2ff','--loc-accent':'#405bb8','--loc-gold':'#8fa8ff','--loc-heading':'#ffffff','--loc-muted':'#b9c6ef','--loc-body-glow':'#173659','--loc-body-mid':'#0a1626','--loc-hero-start':'rgba(21,48,80,.94)','--loc-hero-end':'rgba(7,17,31,.94)'}},
  ...
  {id:'theme-6',styleKey:'element',group:'元素',label:'元素',scheme:'dark',tokens:{'--loc-bg':'#e53935','--loc-panel':'#fff0ef','--loc-panel-2':'#ffc9c6','--loc-text':'#4a0808','--loc-accent':'#e53935','--loc-gold':'#ff706b','--loc-heading':'#710d0d','--loc-muted':'#8f3a3a','--loc-body-glow':'#641d14','--loc-body-mid':'#240c09','--loc-hero-start':'rgba(98,30,21,.95)','--loc-hero-end':'rgba(26,9,8,.95)'}},
