...
const slots=[
  ...
  {id:'theme-8',styleKey:'disorder',group:'無序',label:'無序',scheme:'dark',tokens:{'--loc-bg':'#6b3e2e','--loc-panel':'#fff1eb','--loc-panel-2':'#c98b70','--loc-panel-strong':'rgba(255,241,235,.96)','--loc-panel-nav':'rgba(255,237,229,.95)','--loc-panel-tab':'rgba(248,222,211,.94)','--loc-surface':'rgba(255,241,235,.94)','--loc-surface-soft':'rgba(107,62,46,.07)','--loc-surface-faint':'rgba(107,62,46,.04)','--loc-surface-status':'rgba(107,62,46,.08)','--loc-text':'#3a1f16','--loc-accent':'#7a3f2b','--loc-gold':'#9a6048','--loc-heading':'#24120c','--loc-muted':'#7a4a38','--loc-body-glow':'#5b3022','--loc-body-mid':'#24130e','--loc-hero-start':'rgba(91,48,34,.95)','--loc-hero-end':'rgba(27,16,12,.98)'}}
];
