...
const slots=[
  {id:'theme-1',styleKey:'soul',group:'靈魂',label:'靈魂',scheme:'dark',tokens:{'--loc-bg':'#080f2e','--loc-panel':'#101a46','--loc-panel-2':'#19265c','--loc-panel-strong':'rgba(16,26,70,.94)','--loc-panel-nav':'rgba(8,15,46,.96)','--loc-panel-tab':'rgba(25,38,92,.92)','--loc-rune-bg':'#0c163b','--loc-rune-selected-bg':'#25356f','--loc-line':'rgba(143,168,255,.28)','--loc-line-soft':'rgba(143,168,255,.14)','--loc-line-softer':'rgba(143,168,255,.16)','--loc-line-faint':'rgba(143,168,255,.18)','--loc-text':'#eef2ff','--loc-muted':'#b9c6ef','--loc-heading':'#ffffff','--loc-accent':'#405bb8','--loc-gold':'#8fa8ff','--loc-danger':'#ffb7c8','--loc-surface':'rgba(16,26,70,.88)','--loc-surface-soft':'rgba(143,168,255,.045)','--loc-surface-faint':'rgba(143,168,255,.028)','--loc-surface-status':'rgba(143,168,255,.06)','--loc-accent-surface':'rgba(64,91,184,.16)','--loc-accent-surface-strong':'rgba(64,91,184,.28)','--loc-accent-border':'rgba(143,168,255,.62)','--loc-accent-border-soft':'rgba(143,168,255,.46)','--loc-accent-border-faint':'rgba(143,168,255,.34)','--loc-gold-surface':'rgba(143,168,255,.12)','--loc-gold-surface-soft':'rgba(143,168,255,.08)','--loc-gold-border':'rgba(143,168,255,.64)','--loc-gold-border-soft':'rgba(143,168,255,.48)','--loc-gold-border-faint':'rgba(143,168,255,.36)','--loc-gold-ring':'rgba(143,168,255,.30)','--loc-gold-ring-soft':'rgba(143,168,255,.18)','--loc-danger-border':'rgba(255,183,200,.38)','--loc-primary-start':'#253b92','--loc-primary-end':'#15255f','--loc-body-glow':'#173659','--loc-body-mid':'#0a1626','--loc-hero-start':'rgba(21,48,80,.94)','--loc-hero-end':'rgba(7,17,31,.94)'}},
  ...
  {id:'theme-8',styleKey:'disorder',group:'無序',label:'無序',scheme:'dark',tokens:{'--loc-bg':'#6b3e2e','--loc-panel':'#fff1eb','--loc-panel-2':'#c98b70','--loc-panel-strong':'rgba(255,241,235,.96)','--loc-panel-nav':'rgba(255,241,235,.96)','--loc-panel-tab':'rgba(201,139,112,.94)','--loc-rune-bg':'#fff1eb','--loc-rune-selected-bg':'#e5b29a','--loc-line':'rgba(122,63,43,.28)','--loc-line-soft':'rgba(122,63,43,.14)','--loc-text':'#3a1f16','--loc-muted':'#7a4a38','--loc-heading':'#24120c','--loc-accent':'#7a3f2b','--loc-gold':'#9a6048','--loc-surface':'rgba(255,241,235,.96)','--loc-surface-soft':'rgba(122,63,43,.05)','--loc-surface-faint':'rgba(122,63,43,.03)','--loc-body-glow':'#5b3022','--loc-body-mid':'#24130e','--loc-hero-start':'rgba(91,48,34,.95)','--loc-hero-end':'rgba(27,16,12,.98)'}}
];
