...
const slots=[
  ...
  {id:'theme-2',styleKey:'link',group:'連結',label:'連結組・淺藍',scheme:'light',tokens:{'--loc-bg':'#edf7ff','--loc-panel':'#f9fcff','--loc-panel-2':'#d9efff','--loc-text':'#17334a','--loc-accent':'#5faee3','--loc-gold':'#4d8fb8','--loc-body-glow':'#c6e7fb','--loc-body-mid':'#e8f5ff','--loc-hero-start':'rgba(214,240,255,.97)','--loc-hero-end':'rgba(248,252,255,.99)'}},
