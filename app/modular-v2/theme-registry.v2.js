...
const slots=[
  ...
  {id:'theme-7',styleKey:'order',group:'秩序',label:'秩序',scheme:'light',tokens:{'--loc-bg':'#fffaf0','--loc-panel':'#fffdf7','--loc-panel-2':'#f3ead3','--loc-text':'#342b1d','--loc-accent':'#a9823d','--loc-gold':'#b38a3f','--loc-heading':'#241c10','--loc-muted':'#756348','--loc-body-glow':'#f1dfb5','--loc-body-mid':'#fff8e8','--loc-hero-start':'rgba(255,250,235,.99)','--loc-hero-end':'rgba(255,253,247,.99)'}},
