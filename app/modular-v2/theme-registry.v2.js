...
const slots=[
  {id:'theme-1',styleKey:'soul',group:'靈魂',label:'靈魂',scheme:'dark',tokens:{'--loc-bg':'#080f2e','--loc-panel':'#101a46','--loc-panel-2':'#19265c','--loc-text':'#eef2ff','--loc-accent':'#405bb8','--loc-gold':'#8fa8ff','--loc-heading':'#ffffff','--loc-muted':'#b9c6ef','--loc-body-glow':'#173659','--loc-body-mid':'#0a1626','--loc-hero-start':'rgba(21,48,80,.94)','--loc-hero-end':'rgba(7,17,31,.94)'}},
  ...
  {id:'theme-3',styleKey:'life',group:'生命',label:'生命',scheme:'light',tokens:{'--loc-bg':'#fff1dc','--loc-panel':'#fffaf2','--loc-panel-2':'#ffd39a','--loc-text':'#4a2508','--loc-accent':'#ff8a00','--loc-gold':'#d96500','--loc-heading':'#6b2e00','--loc-muted':'#8a5a2b','--loc-body-glow':'#ffd5a6','--loc-body-mid':'#fff0dc','--loc-hero-start':'rgba(255,216,168,.97)','--loc-hero-end':'rgba(255,249,241,.98)'}},
  {id:'theme-4',styleKey:'nature',group:'自然',label:'自然',scheme:'light',tokens:{'--loc-bg':'#e8f3ea','--loc-panel':'#f6fbf7','--loc-panel-2':'#c8dfcc','--loc-text':'#12351f','--loc-accent':'#1f6b3a','--loc-gold':'#2f7d46','--loc-heading':'#0b2b17','--loc-muted':'#48735a','--loc-body-glow':'#c6e8cb','--loc-body-mid':'#eaf6ec','--loc-hero-start':'rgba(201,235,207,.97)','--loc-hero-end':'rgba(249,253,250,.98)'}},
  ...
  {id:'theme-6',styleKey:'element',group:'元素',label:'元素',scheme:'dark',tokens:{'--loc-bg':'#240606','--loc-panel':'#3a0b0b','--loc-panel-2':'#571010','--loc-text':'#fff5f5','--loc-accent':'#e53935','--loc-gold':'#ff706b','--loc-heading':'#ffffff','--loc-muted':'#f0aaa5','--loc-body-glow':'#641d14','--loc-body-mid':'#240c09','--loc-hero-start':'rgba(98,30,21,.95)','--loc-hero-end':'rgba(26,9,8,.95)'}},
  ...
  {id:'theme-8',styleKey:'disorder',group:'無序',label:'無序',scheme:'dark',tokens:{'--loc-bg':'#24120c','--loc-panel':'#351b12','--loc-panel-2':'#4a281b','--loc-text':'#f7eee9','--loc-accent':'#9a6048','--loc-gold':'#c58b6d','--loc-heading':'#fff8f4','--loc-muted':'#c79f8b','--loc-body-glow':'#5b3022','--loc-body-mid':'#24130e','--loc-hero-start':'rgba(91,48,34,.95)','--loc-hero-end':'rgba(27,16,12,.98)'}}
];
