...
import {CULTURE_OVERVIEW_DESCRIPTION,CULTURE_OVERVIEW_LABEL,cultureDefaultPeriod,isCultureOverview} from '../culture-policy.v2';
...
export default function CultureV2(){
  ...
  return <section className='loc-view'>
    <h1>文化</h1>
    <p className='loc-subtitle'>{CULTURE_OVERVIEW_DESCRIPTION}</p>
