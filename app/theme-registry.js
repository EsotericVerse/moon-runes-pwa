...
export const DEFAULT_THEME_SLOTS=[
  ...
  {id:'theme-7',group:'秩序',identityColor:'#9DBA3A',label:'秩序組・永日',scheme:'light',enabled:true,order:7,tokens:{'--loc-bg':'#f6f9ee','--loc-panel':'#ffffff','--loc-panel-2':'#eaf1d7','--loc-text':'#293313','--loc-accent':'#a8c749','--loc-gold':'#ad922e','--loc-body-glow':'#e4edc2','--loc-body-mid':'#f4f7ec','--loc-hero-start':'rgba(234,243,204,.98)','--loc-hero-end':'rgba(255,255,255,.98)'}},
  {id:'theme-8',group:'無序',identityColor:'#0B0B0B',label:'無序組・灰暗',scheme:'dark',enabled:true,order:8,tokens:{'--loc-bg':'#111214','--loc-panel':'#1a1c1f','--loc-panel-2':'#25282c','--loc-text':'#e5e6e8','--loc-accent':'#8d939b','--loc-gold':'#aaa49a','--loc-body-glow':'#303338','--loc-body-mid':'#17191b','--loc-hero-start':'rgba(48,51,56,.95)','--loc-hero-end':'rgba(17,18,20,.95)'}}
];
